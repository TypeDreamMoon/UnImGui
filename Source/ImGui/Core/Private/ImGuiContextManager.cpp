...
// FONT DATA
#include "FontData/FontData_Style_A.h"
...
int ImFormatStringa(char* buf, size_t buf_size, const char* fmt, ...)
{
	va_list args;
	va_start(args, fmt);
...
void FImGuiContextManager::BuildFontAtlas(const TMap<FName, TSharedPtr<ImFontConfig>>& CustomFontConfigs)
{
	if (!FontAtlas.IsBuilt())
	{
		...
		// CONFIG NAME FONT2Config
		// ImFontConfig Font2Config = {};
		// Font2Config.SizePixels = 15.0f;
		// ImFormatStringa(Font2Config.Name, IM_ARRAYSIZE(Font2Config.Name), "CN3.WOFF, %dpx", (int)Font2Config.SizePixels);
		// const char* font2data_compressed_data_base85 = FontDataBase();
		// FontAtlas.AddFontFromMemoryCompressedBase85TTF(font2data_compressed_data_base85, Font2Config.SizePixels, &Font2Config, FontAtlas.GetGlyphRangesChineseFull());

		//======================================================
		//                          OLD
		//======================================================

		ImFontConfig Font_1_Config = {};
		Font_1_Config.SizePixels = 18.0f;
		ImFormatStringa(Font_1_Config.Name, IM_ARRAYSIZE(Font_1_Config.Name), "FONT_SC_1.TTF, %dpx", (int)Font_1_Config.SizePixels);
		const char* Font1_Data = GetFontData_Font_A();
		FontAtlas.AddFontFromMemoryCompressedBase85TTF(Font1_Data, Font_1_Config.SizePixels, &Font_1_Config, FontAtlas.GetGlyphRangesChineseFull());

		// ImFontConfig Font_2_Config = {};
		// Font_2_Config.SizePixels = 13.0f;
		// ImFormatStringa(Font_2_Config.Name, IM_ARRAYSIZE(Font_2_Config.Name), "FONT_SC_2.TTF, %dpx", (int)Font_2_Config.SizePixels);
		// const char* Font2_Data = GetData_Font_2();
		// FontAtlas.AddFontFromMemoryCompressedBase85TTF(Font2_Data, Font_2_Config.SizePixels, &Font_2_Config, FontAtlas.GetGlyphRangesChineseFull());
